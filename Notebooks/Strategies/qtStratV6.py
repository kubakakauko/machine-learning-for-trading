...
HISTORICAL_LIMIT = 2000  # Number of historical candles to fetch

# Account and Risk Management
ACCOUNT_BALANCE = 100  # Example starting balance in USD
RISK_PER_TRADE = 0.001  # Risk 1% of account per trade
...
class BTCLiveChart(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # Add a checkbox to toggle entering trades before candle close
